            ...
            <div className="p-5 flex flex-col flex-1">
                ...
                <div className="space-y-3 mb-6">
                    <div className="flex justify-between items-center text-sm">
                        ...
                        <span className="font-bold text-white">{investment.tokenBalance.toLocaleString()} {investment.tokenSymbol}</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-gray-400">Current Value</span>
                        <span className="font-bold text-green-400">฿{investment.invested.toLocaleString()}</span>
                    </div>
                </div>
